...
def robustness_test(session, X, y, noise_levels=np.linspace(0, 1, 20), save_path='robustness_plot.png'):
    """
...
def robustness_test_two_models(session_1, session_2, X, y, noise_levels=np.linspace(0, 1, 20), save_path='robustness_plot.png'):
    """
