...
def plot_robustness_results(model_1_results, model_2_results, save_path='results/comparison_results/robustness_plot.png'):
    noise_levels = model_1_results['noise_levels']
    accuracies_1 = model_1_results['accuracies']
    accuracies_2 = model_2_results['accuracies']
    prediction_differences_1 = model_1_results['prediction_differences']
    prediction_differences_2 = model_2_results['prediction_differences']
